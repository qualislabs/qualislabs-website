...
import MetadataCursor from './components/MetadataCursor'
    ...
    <div className="app-shell">
      ...
      <footer className="site-footer">
        <div>
          ...
          <p className="footer-copy">Production-grade AI and systems infrastructure for complex operating environments.</p>
        </div>
